...
public struct NetworkManager {
    ...
    func performAPIRequestByMethod(method: String, completion: @escaping (Result<Data, NetworkManagerError>) -> Void) {
    ...
    func performAPIRequestByURL(url: String, completion: @escaping (Result<Data, NetworkManagerError>) -> Void) {
